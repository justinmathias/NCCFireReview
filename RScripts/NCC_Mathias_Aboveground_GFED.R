...
#Load in data
agb <- read.xlsx("/Users/justinmathias/Dropbox/Research/UIdaho Postdoc/NCCFireReview/Data/Raw files/aboveground_longform_v3_GFED.xlsx")
...
write.csv(AGB_converted_final, "AbovegroundConvertedGFED.csv")
